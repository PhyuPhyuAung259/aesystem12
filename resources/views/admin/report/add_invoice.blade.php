...
<div class="container">
	...
	<table class="table table-striped" style="border: solid 1px #c4c2c2;">
		...
		<tr>
			...
			<td class="text-right"><b>{{ Content::money($project->project_add_invoice) }}  {{ Content::money($project->project_nadd_invoice)  }} {{Content::currency()}}</b></td>
		</tr>
		<tr style="background: white;">

			<td class="text-right" colspan="3"><strong style="text-transform:uppercase;">Grand Total:</strong>
				<b>{{ Content::money($project->project_add_invoice) }} {{ Content::money($project->project_nadd_invoice)  }} {{Content::currency()}}</b>
			</td>
		</tr>
	</table>
