                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 col-xs-6">
                      <div class="form-group">
                        ...
                        <!--<input type="text" class="form-control" name="add_invoice" placeholder="Additional Invoice" value="{{$project->project_add_invoice ?? $project->project_nadd_invoice  ?? old('add_invoice') }}" />-->
                        <input type="text" class="form-control" name="add_invoice" placeholder="Additional Invoice" value="{{ $project->project_add_invoice > 0 ? $project->project_add_invoice : ($project->project_nadd_invoice > 0 ? $project->project_nadd_invoice : old('add_invoice'))}}" />
                      </div> 
                    </div>
                    <div class="col-md-3 col-xs-6">
                      <div class="form-group">
                        <label>Credit Note</label> 
                        <!--<input type="text" class="form-control" name="cnote_invoice" placeholder="Credits Note" value="{{$project->project_cnote_invoice ?? old('cnote_invoice') ?? $project->project_ncnote_invoice  }}"/>-->
                        <input type="text" class="form-control" name="cnote_invoice" placeholder="Credits Note"
       value="{{ $project->project_cnote_invoice > 0 ? $project->project_cnote_invoice : ($project->project_ncnote_invoice > 0 ? $project->project_ncnote_invoice : old('cnote_invoice')) }}" />
                      </div> 
                    </div>
                    <div class="col-md-3 col-xs-6">
                      <div class="form-group">
