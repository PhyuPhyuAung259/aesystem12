              ...
              <table class="datatable table table-hover table-striped">
                <thead>
                  <tr>                       
                    ...
                    <th class="text-right" title="Gross Profit">( Margin % )</th>
                    <th class="text-right" title="Gross Profit">( Market % )</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <?php 
                      ...
                      $getmarginPercentage = $acc_revenue > 0 ? ($grossProfit / $acc_revenue) * 100 : 0;
                      $getmarketPercentage = $acc_revenue > 0 ? ($grossProfit / $acc_Cost_of_sales) * 100 : 0;
                    ...
                    <td class="text-right"><a href="javascript:void(0)"><b>{{Content::money($getmarginPercentage)}} {{$getmarginPercentage > 0 ? "%": ''}}</b></a></td>
                    <td class="text-right"><a href="javascript:void(0)"><b>{{Content::money($getmarketPercentage)}} {{$getmarketPercentage > 0 ? "%": ''}}</b></a></td>
