...
use App\Models\CrPrice;
use App\Models\Project;
use App\Models\FsPrice; 
...
class AdminController extends Controller
{
    ...
    public function getflights(Request $request, $country)
    {
        $flights = Supplier::where(['country_id'=>$country,'business_id'=>37] )->orderBy('supplier_name', 'asc')->get();
